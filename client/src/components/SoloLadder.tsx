    ...
    <div className="sm:pt-40 pt-20 h-screen w-screen relative overflow-x-hidden">
      ...
      {Boolean(reportMatchModalVisible) && (
        <div className="flex fixed top-0 right-0 left-0 bottom-0 justify-center items-center sm:mt-10 w-full z-10">
          <div className="sm:overflow-y-hidden overflow-y-scroll xl:w-1/3 lg:w-1/2 w-5/6 sm:h-auto h-3/4 sm:px-16 sm:py-8 px-8 py-8 rounded-md bg-black-opacity-90">
                ...
                <>
                  <div className="grid grid-cols-1 gap-x-8 gap-y-4 sm:grid-cols-2">
                    ...
                    <div className="col-span-2">
                      ...
                      <div className="mt-2.5">
                        <select
                          className="block w-2/3 rounded-md px-3.5 py-2 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                          value={reportedMap}
